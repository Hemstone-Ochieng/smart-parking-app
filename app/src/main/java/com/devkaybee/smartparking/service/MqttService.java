...
public class MqttService extends Service implements MqttTraceHandler {
  ...
  private MqttServiceBinder mqttServiceBinder;
	...
	private Map<String/* clientHandle */, org.eclipse.paho.android.service.MqttConnection/* client */> connections = new ConcurrentHashMap<>();
  ...
  public String getClient(String serverURI, String clientId, String contextId, MqttClientPersistence persistence) {
    ...
    if (!connections.containsKey(clientHandle)) {
      org.eclipse.paho.android.service.MqttConnection client = new org.eclipse.paho.android.service.MqttConnection(this, serverURI,
  ...
  public void connect(String clientHandle, MqttConnectOptions connectOptions,
      ...
      throws MqttSecurityException, MqttException {
	  	org.eclipse.paho.android.service.MqttConnection client = getConnection(clientHandle);
  ...
  void reconnect() {
	...
	for (org.eclipse.paho.android.service.MqttConnection client : connections.values()) {
   ...
   */
  private org.eclipse.paho.android.service.MqttConnection getConnection(String clientHandle) {
    org.eclipse.paho.android.service.MqttConnection client = connections.get(clientHandle);
    if (client == null) {
  ...
  private class NetworkConnectionIntentReceiver extends BroadcastReceiver {
    ...
    private void notifyClientsOffline() {
		for (org.eclipse.paho.android.service.MqttConnection connection : connections.values()) {
			connection.offline();
		}
	}
